      ...
      <div className='flex justify-center items-center h-screen'>
        <div >
          ...
          <div className="title flex flex-col items-center">
            <h4 className='text-5xl font-bold text-slate-500'>Recovery</h4>
          ...
          <div className="text-center py-4">
            ...
            {' '}
            <span className='text-gray-500'>Something Went's Wrong? <button onClick={navigateToHome} className='text-red-500'>Back</button></span>
          </div>
